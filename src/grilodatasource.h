...
public:
  enum MetadataKeys {
    ...
    Size = GRL_METADATA_KEY_SIZE,
    TitleFromFilename = GRL_METADATA_KEY_TITLE_FROM_FILENAME,
    MbAlbumId = GRL_METADATA_KEY_MB_ALBUM_ID,
    MbTrackId = GRL_METADATA_KEY_MB_TRACK_ID,
    MbArtistId = GRL_METADATA_KEY_MB_ARTIST_ID,
    MbRecordingId = GRL_METADATA_KEY_MB_RECORDING_ID,
    EpisodeTitle = GRL_METADATA_KEY_EPISODE_TITLE,
    AudioTrack = GRL_METADATA_KEY_AUDIO_TRACK,
  };
